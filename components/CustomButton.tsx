const CustomButton = ({
  ...
  return (
    ...
    >
      <span className="absolute top-1/2 -translate-x-20 ease bg-black duration-300 group-hover:h-64 group-hover:-translate-y-32 h-0 origin-center rotate-45 transition-all w-64"></span>
